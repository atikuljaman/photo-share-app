      ...
      <div className="flex flex-col pb-5">
        <div className="relative flex-flex col mb-7">
          <div className="flex flex-col justify-center items-center">
            ...
            <img
              src={user?.image}
              className="w-20 h-20 -mt-10 rounded-full shadow-xl object-cover"
              alt="user-pic"
            />
            ...
            <div className="absolute top-0 right-0 z-1 p-2">
              {userId === user?._id && (
                <button
                  type="button"
                  className="bg-red-500 shadow-md flex gap-2 items-center text-white p-2 px-3 rounded-full cursor-pointer outline-none"
                  onClick={() => {
                    googleLogout();
                    localStorage.clear();
                    navigate("/login");
