            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-white flex items-center gap-2 font-bold text-black p-1 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md"
                >
              ...
              {postedBy?._id === user?.sub && (
                <button
                  ...
                  type="button"
                  className="bg-white p-2 opacity-70 hover:opacity-100 text-dark font-bold px-5 text-base rounded-full hover:shadow-md outline-none"
                >
                  <AiTwotoneDelete />
                </button>
              )}
