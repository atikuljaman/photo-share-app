...
const PinDetail = ({ user }) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex justify-center mt-3 items-center md:items-start flex-initial">
          <img
        ...
        <div className="w-full flex-1 p-5 xl:min-w-620">
          <div className="flex items-center justify-between">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-white underline flex items-center gap-2 font-bold text-black p-1 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md"
            >
          ...
          <div className="flex flex-wrap mt-6 gap-3">
            ...
            <button
              type="button"
              className="bg-red-500 text-white rounded-full px-6 py-2 text-semibold text-base outline-none"
              onClick={addComment}
            >
